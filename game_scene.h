...
static void game_scene_print_face(char** face, int size, int lastv, int lasth, int loop_c, int running)
{   while(clear(), 0){}
...
{   while(srand((int)time(0)), 0){}
    ...
    while(game_scene_print_face(face, size, GAME_SCENE_BOARD_TOP, GAME_SCENE_BOARD_LEFT, DEFAULT_INT, 1), 0){}
